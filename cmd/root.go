// Copyright © 2021 Guillaume Renard <renardguillaume@gmail.com>
//
...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.pipicker.yaml)")
